...
export default function Hero() {
  return (
    <section className="w-full flex flex-col md:flex-row h-auto md:h-[80vh] border-0 md:border-10 rounded-3xl overflow-hidden mb-3">
      {/* Izquierda (60%) */}
      <div className="md:w-4/6 w-full py-8 md:py-16 px-0 md:px-4 md:p-64 flex items-center justify-center bg-orange-300">
        <div className="flex flex-col justify-center items-center text-center p-3x">
          ...
          <button className="mt-4 bg-orange-400 hover:bg-organge-500 text-white text-lg md:text-xl font-semibold py-3 px-8 rounded-full shadow-md transition-transform duration-300 hover:scale-105 animate-fade-up delay-400">
            Comenzá ahora
          </button>
        </div>
      </div>
